...
/* Run the original internal-loopback stack test and inspect
 * g_CanLoopbackTestResult at the final loop. PduR routes Tx, Rx and
 * confirmation to COM while the test observes their debugger snapshots.
 */
/*=========================================================================
